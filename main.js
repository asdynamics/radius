...
const fallbackPeople = [
  {
    ...
    name: "브라이언 스티븐슨",
    date: "2026.07.09",
    summary: "사건 번호가 한 사람을 삼키려 할 때, 그는 끝까지 이름을 되돌려 놓았다.",
  ...
  },
  {
    ...
    name: "조이 부올람위니",
    date: "2026.07.07",
    summary: "흰 가면 앞에서 멈춘 카메라는 알고리즘 정의라는 질문으로 이어졌다.",
  ...
  },
  {
    ...
    name: "미카엘라 로치",
    date: "2026.07.07",
    summary: "사라진 해변에서 북해의 법정과 칼레의 국경까지, 그의 기후정의는 계속 장소를 옮긴다.",
  ...
  },
  {
    ...
    name: "바네사 나카테",
    date: "2026.07.02",
    summary: "캄팔라의 거리에서 투르카나의 병원까지, 기후위기는 아이와 학교와 숲의 얼굴을 얻는다.",
  ...
  },
  {
    ...
    name: "오텀 펠티어",
    date: "2026.06.30",
    summary: "물 한 잔을 공동체와 미래세대의 약속으로 다시 바라보게 한다.",
